...
const GridsterConfig: GridsterConfig = {
  ...
  minCols: 7, // minimum amount of columns in the grid
  ...
  minItemCols: 7, // min item number of columns
  ...
  itemRemovedCallback: undefined,  // callback to call for each item when is removed.
    // Arguments: gridsterItem, gridsterItemComponent
  enableEmptyCellClick: true, // enable empty cell click events
  enableEmptyCellContextMenu: true, // enable empty cell context menu (right click) events
  enableEmptyCellDrop: true, // enable empty cell drop events
  enableEmptyCellDrag: true, // enable empty cell drag events
  ...
  displayGrid: 'always', // display background grid of rows and columns. Options: 'always' | 'onDrag&Resize' | 'none'
