...
module.exports = "\r\n<mat-card>\r\n\r\n  <mat-card-title>\r\n      <form class=\"searchbar-form\"(ngSubmit)=\"onNewSubmit()\">\r\n        <mat-form-field class=\"searchbar-full-width\">\r\n          <input matInput placeholder=\"Add or Copy a Thought\" aria-label=\"Thought\" [matAutocomplete]=\"auto\" [formControl]=\"thoughtCtrl\">\r\n            <mat-autocomplete #auto=\"matAutocomplete\">\r\n              <mat-option *ngFor=\"let thought of filteredThoughts | async\" [value]=\"thought.label\" (click)=\"copyThought(thought)\">\r\n                <span>{{ thought.label }}</span><small *ngFor=\"let context of thought.contexts\"> | {{ context.label }}</small>\r\n              </mat-option>\r\n            </mat-autocomplete>\r\n          \r\n          </mat-form-field>\r\n\r\n      </form>\r\n    </mat-card-title>\r\n    <mat-card-content> \r\n      <button mat-raised-button *ngIf=\"selectedThought.label\">Add to Context: {{ selectedThought.label }} </button>\r\n    </mat-card-content>\r\n    \r\n    <mat-card-actions>\r\n      <button mat-button (click)=saveGoal()><i class=\"material-icons\">insert_invitation</i>Save as Goals</button>\r\n      <button mat-button><i class=\"material-icons\">note</i>Save as Diary Entry</button>\r\n  </mat-card-actions>\r\n</mat-card>"
...
var NewComponent = (function () {
    ...
    NewComponent.prototype.saveGoal = function () {
        var newGoal = new __WEBPACK_IMPORTED_MODULE_8__models_dimension__["a" /* Dimension */];
        newGoal.dim = "goals";
        var date = Date.now;
                                                        ...
                                                        _this.dataService.newThought(goals).subscribe(function (data) {
                                                            ...
                                                            _this.dataService.newThought(projects).subscribe(function (data) {
                                                                ...
                                                                _this.dataService.editThought(editThought).subscribe(function (data) {
                                                                    var editPlans = {
                                                                        _id: _this.todoId,
                                                                        editContents: [{ _id: _this.goals }, { _id: _this.projects }]
                                                                    };
                                                                    var editMemories = {
                                                                    ...
                                                                    _this.dataService.editThought(editPlans).subscribe(function (data) {
                                                                        _this.dataService.editThought(editMemories).subscribe(function (data) {
                                                                            //LEVEL 3: GOALS
                                                                            var today = {
                                                                                label: "Today",
                                                                                level: 3,
                                                                                ...
                                                                                showAs: "list",
                                                                                dimensions: [],
                                                                                contexts: [{ _id: _this.goals }, { _id: _this.todoId }, { _id: _this.startId }],
                                                                                privacy: "locked"
                                                                            };
                                                                            var week = {
                                                                                label: "This Week",
                                                                            ...
                                                                            _this.dataService.newThought(today).subscribe(function (data) {
                                                                                _this.today = data.newId;
                                                                                _this.dataService.newThought(week).subscribe(function (data) {
                                                                                    _this.week = data.newId;
                                                                                    _this.dataService.newThought(month).subscribe(function (data) {
                                                                                        _this.month = data.newId;
                                                                                        _this.dataService.newThought(year).subscribe(function (data) {
                                                                                            _this.year = data.newId;
                                                                                            _this.dataService.newThought(life).subscribe(function (data) {
                                                                                                _this.life = data.newId;
                                                                                                _this.dataService.newThought(all).subscribe(function (data) {
                                                                                                    _this.all = data.newId;
                                                                                                    var editGoals = {
                                                                                                        _id: _this.goals,
                                                                                                        editContents: [{ _id: _this.today }, { _id: _this.week }, { _id: _this.month }, { _id: _this.year }, { _id: _this.life }, { _id: _this.all }]
                                                                                                    };
                                                                                                    _this.dataService.editThought(editGoals).subscribe(function (data) {
                                                                                                        //LEVEL 3: Diary
                                                                                                        var feelings = {
                                                                                                            label: "Feelings",
                                                                                                            level: 3,
                                                                                                            ...
                                                                                                            showAs: "list",
                                                                                                            dimensions: [],
                                                                                                            contexts: [{ _id: _this.diary }, { _id: _this.sessionsId }, { _id: _this.startId }],
                                                                                                            privacy: "locked"
                                                                                                        };
                                                                                                        var memory = {
                                                                                                            label: "Happenings",
                                                                                                        ...
                                                                                                        _this.dataService.newThought(feelings).subscribe(function (data) {
                                                                                                            _this.feeling = data.newId;
                                                                                                            _this.dataService.newThought(memory).subscribe(function (data) {
                                                                                                                _this.memory = data.newId;
                                                                                                                var editDiary = {
                                                                                                                    _id: _this.diary,
                                                                                                                    editContents: [{ _id: _this.feeling }, { _id: _this.memory }]
                                                                                                                };
                                                                                                                _this.dataService.editThought(editDiary).subscribe(function (data) {
                                                                                                                    var editUser = {
                                                                                                                        _id: _this.userId,
                                                                                                                        editStarter: _this.startId,
                                                                                                                        editUnstructured: _this.timeline,
                                                                                                                        editGoals: _this.all,
                                                                                                                        editFeelings: _this.feeling,
                                                                                                                        editHappenings: _this.memory
                                                                                                                    };
                                                                                                                    ...
                                                                                                                    _this.authService.editUser(editUser).subscribe(function (data) {
                                                                                                                        ...
                                                                                                                        _this.internalService.loadThoughts();
                                                                                                                        _this.internalService.changeThought(_this.startId);
                                                                                                                        console.log(_this.messageClass);
                                                                                                                        setTimeout(function () {
                                                                                                                            _this.router.navigate(['/viewer']); // Redirect to viewer
                                                                                                                        }, 1500);
                                                                                                                    });
                                                                                                                });
                                                                                                            });
...
module.exports = "\n\n<!-- Contexts -->\n<mat-toolbar>\n        <div *ngFor=\"let context of contexts\"><button mat-button (click)=\"selectThought(context)\">{{ context.label }}</button></div>\n     <div><button mat-raised-button (click)=\"selectThought(context)\">{{ context.label }}</button></div>\n    \n</mat-toolbar>\n\n<mat-toolbar>\n        <!-- Siblings -->\n<div *ngFor=\"let sibling of siblings\">\n    <div *ngIf=\"selectedThought.label != sibling.label\"><button mat-button (click)=\"selectThought(sibling)\">{{ sibling.label}}</button></div>\n    <div *ngIf=\"selectedThought.label == sibling.label\"><button mat-raised-button (click)=\"selectThought(sibling)\">{{ sibling.label}}</button></div>\n</div>\n</mat-toolbar>\n\n        <mat-grid-list [cols]=\"contents.length || 1\" rowHeight=\"2:1\">\n                <mat-grid-tile *ngFor=\"let content of contents\"\n                            [colspan]=\"1\"\n                            [rowspan]=\"1\">\n                    <mat-card>\n                        <mat-card-title><button class=\"content-title\" mat-button (click)=\"selectThought(content)\">{{ content.label }}</button></mat-card-title>\n                        <mat-card-content>\n                                <div *ngIf=\"content.contents.length\">\n                                    <mat-list>\n                                            <mat-list-item *ngFor=\"let thought of content.contents\" ><button mat-button (click)=\"selectThought(thought)\">{{ thought.label }}</button> </mat-list-item>\n                                    </mat-list>\n                                </div>   \n                        </mat-card-content>   \n                    </mat-card>\n                </mat-grid-tile>\n        </mat-grid-list>\n             \n\n<app-footer></app-footer>"
...
var InternalService = (function () {
    ...
    InternalService.prototype.changeThought = function (id) {
        ...
        this.dataService.getThought(id).subscribe(function (data) {
            _this.selThought.next(data.thought);
            _this.dataService.getContent(data.thought.contexts[0]._id).subscribe(function (data) {
                _this.selSiblings.next(data.thought.contents); //Save Selected Thought
            });
